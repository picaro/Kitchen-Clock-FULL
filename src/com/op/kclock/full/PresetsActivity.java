...
import com.op.kclock.full.dialogs.DialogUtils;
...
public class PresetsActivity extends Activity implements OnClickListener {
	...
	private void setDrawable(View mainview, BitmapDrawable bitmap) {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.menu_delete_all: {
			final LinearLayout presetsList = (LinearLayout) findViewById(R.id.presets_list);
			final List<AlarmClock> presetsf = presets;
			DialogUtils.createDialog(
					this,
					getApplicationContext().getString(
							R.string.delete_preset_title),
					getApplicationContext().getString(
							R.string.delete_preset_message),
					getApplicationContext().getString(R.string.yes),
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int id) {
							PresetsActivity
									.deleteAllPresets(getApplicationContext());
							presetsf.clear();
	...
	public static void deleteAllPresets(Context context) {
		...
		dbHelper.close();
		// final LinearLayout presetsList = (LinearLayout)
		// findViewById(R.id.presets_list);
		// presetsList.removeAllViews();
		// presets.clear();
	}
